...
<%--error msg--%>
   ...
   <div class="container">
    ...
    <div class="grid">
                        ...
                        <asp:GridView ID="gdvProgramaManager" runat="server"   CssClass="gridView" DataKeyNames="idProgramacionHeader"                     
                            ...
                            <Columns>
                               ...
                               <%-- <asp:BoundField DataField="dateFechaInicioBoletinHeader" HeaderText="Fecha Inicio"   />
                                ...
                                <asp:BoundField DataField="vUserCreo"       meta:resourceKey="htUsuario" HeaderText="Creado Por" HeaderStyle-Width="350px">   <HeaderStyle Width="350px"></HeaderStyle></asp:BoundField>
                                ...
                                <ItemTemplate>                                         
                                    ...
                                    Visible='<%#
                                    string.Compare(GetValor((string)Eval("estatus")),"Cancelado_", true) == 0 || string.Compare(GetValor((string)Eval("estatus")),"Ejecutado_".ToString(), false) == 0   || string.Compare(GetValor((string)Eval("estatus")),"Entregado_", false) == 0   || string.Compare(GetValor((string)Eval("estatus")),"Entrega Parcial_".ToString(), false) == 0  ? false : true 
                                    %>'
                                    />
                                </ItemTemplate>
                                </asp:TemplateField>
     ...
     <asp:Panel ID="pnlCapturaHoras" runat="server" CssClass="modalPopup" Style="" width="370px">               
      <table class="index3" align="center" style="min-width:350px; margin:5px;">          
          <tr>
              <td  style="text-align:right; background:#ffa05f;" >  
                ...
                <tr>
                    <td >                    
                        <asp:Button CssClass="button" runat="server" meta:resourceKey="btnGuardar" ID="save" Text="Sí" OnClick="save_Click" />
                        <asp:Button CssClass="button" runat="server" meta:resourceKey="btnCancelar" ID="btnCancel" Text="No" />
                    </td>
                </tr> 
        </table>
    </asp:Panel>
