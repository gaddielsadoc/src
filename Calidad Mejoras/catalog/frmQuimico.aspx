    ...
    <script type="text/javascript">
        ...
        $('#' + formId).validate({
            ...
            messages: {
                ...
                '<%=txtMaxAplCiclo.UniqueID%>': { required: '<%= (string)GetLocalResourceObject("maxA") %>', number: '<%= (string)GetLocalResourceObject("maxAN") %>', existePlaga: '<%= (string)GetLocalResourceObject("maxAP") %>', decimal4Float: '<%= (string)GetLocalResourceObject("maxAD") %>' },
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="container">
        ...
        <h1 style="width:1480px; max-width:1480px; min-width:1480px; display:table; margin-left:auto; margin-right:auto;"><asp:Label ID="lblBienvenido" runat="server" meta:resourceKey="lblBienvenido"></asp:Label></h1>
        <asp:Panel ID="form" runat="server">
        <table  class="index" style="min-width:1480px; max-width:1480px; width:1480px;">
            <tr>
                <td colspan="6">
                   <h2>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="txtIngrediente" runat="server" ></asp:TextBox></td>
                ...
                <td><asp:TextBox ID="txtTolerancia" runat="server"></asp:TextBox></td>
            </tr>
            
            <tr>
                <td><asp:Literal ID="Literal2" runat="server" Text="Intervalo de seguridad a cosecha" meta:resourceKey="Literal2"></asp:Literal></td>
                <td style="text-align:left;"><asp:TextBox ID="txtIntervalo" runat="server" ></asp:TextBox> <%= (string)GetLocalResourceObject("dias") %></td>
                <td><asp:Literal ID="Literal4" runat="server" Text="Tiempo de reentrada" meta:resourceKey="Literal4"></asp:Literal></td>
                <td style="text-align:left;"><asp:TextBox ID="txtTiempo" runat="server"></asp:TextBox> <%= (string)GetLocalResourceObject("horas") %></td>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="txtPersist" runat="server"></asp:TextBox></td>
            </tr>
            ...
            <tr>
                ...
                <td class="none">
                    <asp:TextBox ID="txtTiempoAplicacionHrs" runat="server" CssClass="cajaChica none"></asp:TextBox> : <asp:TextBox ID="txtTiempoAplicacionMin" runat="server" CssClass="cajaChica"></asp:TextBox>
                </td>
            </tr>
            ...
            <div class="grid" >
                ...
                <select class="pagesize cajaCh" style="width: 50px; min-width: 50px; max-width: 50px;">
                 ...
                 <asp:GridView ID="gvQuimico" runat="server" EnableModelValidation="True" HeaderStyle-CssClass="wrapped" 
                        ...
                        >
                        <Columns>
                            <asp:BoundField	DataField="ITMSHNAM"	HeaderText="Nombre Comercial" meta:resourceKey="ITMSHNAM" />			
                            <asp:BoundField	DataField="d6_INGACT"	HeaderText="Ingrediente Activo" meta:resourceKey="d6_INGACT"/>			
                            <asp:BoundField	DataField="d6_EPA180"	HeaderText="EPA Ref.#180" meta:resourceKey="d6_EPA180"/>			
                            <asp:BoundField	DataField="d6_EPATOL"	HeaderText="Tolerancia EPA. ppm" meta:resourceKey="d6_EPATOL"/>		
                            <asp:BoundField	DataField="d6_REENT"	HeaderText="Tiempo de reentrada" meta:resourceKey="d6_REENT"/>	
                            <%-- INDICACIONES --%>
                            ...
                            <%-- INDICACIONES --%>	
                            <asp:BoundField	DataField="d6_GPOQUIM"	HeaderText="Grupo Químico" meta:resourceKey="d6_GPOQUIM" />
                            <%--ABEJORROS --%>
                            <asp:TemplateField HeaderText="Comp. Abejorros"  HeaderStyle-HorizontalAlign="Center"
                                ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="80px" meta:resourceKey="CompA">
                                <ItemTemplate>
                            ...
                            <%--ABEJORROS --%>
                            <asp:BoundField	DataField="d6_PERSIS"	HeaderText="Persistencia Días" meta:resourceKey="d6_PERSIS"  />			
                            <%--DOSIS --%>
                           <%-- <asp:TemplateField HeaderText="Dosis"  HeaderStyle-HorizontalAlign="Center"
                            ...
                            <asp:BoundField	DataField="d6_TYPEQUIM" HeaderText="Tipo de químico" meta:resourceKey="d6_TYPEQUIM"/>	 				
