...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="index" style="width:870px; max-width:870px; min-width:870px;">
       ...
       <tr>
            ...
            <tr> <td colspan="5">
                            <asp:Button ID="btnValidar" runat="server" meta:resourceKey="btnValidar" Text="Validar" Visible="false"  onclick="btnValidar_Click" />
                        </td></tr>
       ...
       <tr>
        ...
        <tr><td>
            <asp:TextBox ID="txtObs" runat="server" TextMode="MultiLine" MaxLength="1000" 
                ...
                <tr><td>
                            <asp:Button ID="btnGuardar" runat="server" Text="Guardar"  meta:resourceKey="btnGuardar"
              ...
              <td colspan="2" style="text-align:right; background:#ffa05f;" >  
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <asp:Button CssClass="button" runat="server" meta:resourceKey="btnGuardar" ID="save" Text="Guardar" OnClick="save_Click" />
