    ...
    <div class="grid">
     ...
     <td> <select class="pagesize cajaCh" style="width: 50px; min-width: 50px; float:none; max-width: 50px;">
            ...
            EnableModelValidation="True">
                <Columns>
                    <asp:BoundField DataField="NoOrden" meta:resourceKey="htOrden" 
                        HeaderText="Orden" HeaderStyle-Width="200px" >
<HeaderStyle Width="200px"></HeaderStyle>
                    </asp:BoundField>
                    <asp:BoundField DataField="planta" meta:resourceKey="htPlanta" 
                        HeaderText="Site" HeaderStyle-Width="200px" >
<HeaderStyle Width="200px"></HeaderStyle>
                    </asp:BoundField>
                    <asp:BoundField DataField="invernadero" meta:resourceKey="htInvernadero" 
                        HeaderText="Invernadero" HeaderStyle-Width="200px">
<HeaderStyle Width="200px"></HeaderStyle>
                    </asp:BoundField>
                    <asp:BoundField DataField="semana" meta:resourceKey="htSemana" 
                        HeaderText="Semana" HeaderStyle-Width="200px">
<HeaderStyle Width="200px"></HeaderStyle>
                    </asp:BoundField>
                    <asp:BoundField DataField="fechaAplicacion" meta:resourceKey="htFechaApliacion" 
                        HeaderText="Fecha de aplicación" HeaderStyle-Width="200px" 
                        DataFormatString="{0:yyyy-MM-dd}">
<HeaderStyle Width="200px"></HeaderStyle>
                    </asp:BoundField>
                    <asp:BoundField DataField="hora" meta:resourceKey="htHora" 
                        HeaderText="Hora de aplicación" HeaderStyle-Width="200px">
<HeaderStyle Width="200px"></HeaderStyle>
                    </asp:BoundField>
